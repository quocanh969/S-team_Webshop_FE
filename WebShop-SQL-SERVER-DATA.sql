use Nhom14_WebShop;
/* Customers */
insert into users(email, password, dial, address, status) values('lamtehao@gmail.com', '1612175', '0933337663', 'DH KHTN Q5 TPHCM', 'true');
insert into users(email, password, dial, address, status) values('tranquocanh858@gmail.com', '1612018', '0365635427', 'DH KHTN Q5 TPHCM', 'true');
/* Employees */
insert into users(email, password, dial, address, status, type) values('baoit256@gmail.com', '1612036', '0938443767', 'DH KHTN Q5 TPHCM', 'true', 1);
insert into employees(id) values(3);
/* Admins */
insert into users(email, password, dial, address, status, type) values('admin@gmail.com', '12345678', '0123456789', 'DH KHTN Q5 TPHCM', 'true', 2);
insert into admins(id) values(4);
/* Categories */
insert into categories(name, status) values('Framework', 'true');
insert into categories(name, status) values('IDE', 'true');
insert into categories(name, status) values('Windows', 'true');
insert into categories(name, status) values('iOS', 'true');
insert into categories(name, status) values('StackOverflow', 'true');
insert into categories(name, status) values('Other', 'true');
/* Sub-categories*/
/*
insert into categories(name, status, parent_id) values('Yii', 'true', 1);
insert into categories(name, status, parent_id) values('Spring', 'true', 1);
insert into categories(name, status, parent_id) values('Other', 'true', 1);

insert into categories(name, status, parent_id) values('VisualStudio', 'true', 2);
insert into categories(name, status, parent_id) values('Xcode', 'true', 2);
insert into categories(name, status, parent_id) values('Other', 'true', 2);
*/
/* Products */
...
/* Invoices */
insert into invoices(id_customer, status, createDate, estimatedDeliveryDate, total) values(1, 3, getdate(), getdate(), 30);
...
insert into invoices(id_customer, status, createDate, estimatedDeliveryDate, total) values(2, 3, getdate(), getdate(), 10);
